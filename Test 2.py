...
#Выяснить, пересекаются ли параболы y = ax2 + bx + c и y = dx2 + ex + f. Если да, найти точки пересечения.
...
if D >= 0:
    ...
    print('parabolas do not intersect')
...
if min_l_ind < max_l_ind:
    ...
    print('Geometric mean: ', sr_geom, l)
...
n = 7 #max кол-во звездочек в строке
sym = '*'
